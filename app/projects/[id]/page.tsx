    ...
    return (
      <div className="p-8 md:p-12">
        ...
        <p className="text-muted-foreground mt-3">
          Silakan kembali ke halaman proyek dan pilih item yang tersedia.
        </p>
      </div>
    );
  }
        ...
        <Card className="overflow-hidden border border-border/50 bg-card">
          ...
          <CardContent className="space-y-6 p-6">
              ...
              <div className="flex flex-wrap gap-2">
                {project.tech.map((tech) => (
                  <Badge
                    key={tech}
                    variant="secondary"
                    className="bg-muted/60 text-[10px] font-mono px-2 py-0"
                  >
                    {tech}
                  </Badge>
                ))}
            ...
            <div className="flex flex-wrap gap-3 pt-3">
              <a
                href={project.link}
                className="rounded-full border border-border/60 px-4 py-2 text-sm transition hover:bg-muted"
              >
                Demo Langsung
              </a>
              <a
