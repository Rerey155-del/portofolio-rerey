...
export const PROJECTS_DATA: ProjectData[] = [
  ...
  {
    id: 6,
    title: "CX Voting - UKM IT Cybernetix",
    description:
      "Aplikasi berbasis web ini dirancang khusus untuk memenuhi kebutuhan UKM IT Cybernetix dalam menyelenggarakan pemilihan kandidat ketua dan wakil ketua secara digital. Sistem ini menyediakan fitur lengkap mulai dari registrasi pemilih, manajemen kandidat, hingga proses pemilihan. Seluruh data dikelola secara terpusat, memungkinkan admin untuk memonitor jalannya pemilihan secara real-time serta menghasilkan laporan rekapitulasi suara secara otomatis setelah pemilihan berakhir.",
    image: "/cxvote1.png",
    images: ["/cxvote1.png", "/cxvote2.png", "/cxvote3.png"],
    type: "Web",
